...
public class TokenProvider {
    ...
    public String createToken(User userEntity, String secretKey, long duration, ChronoUnit unit) {
        ...
        claims.put("role", userEntity.getLoginPath().toString());
        ...
        return Jwts.builder()
                ...
                .setSubject(userEntity.getUserNo()) // sub: 토큰을 식별할 수 있는 주요 데이터
                .compact();
    }
    ...
    public TokenUserInfo validateAndGetTokenUserInfo(String token) {
        ...
        return TokenUserInfo.builder()
                ...
                .loginPath(LoginPath.valueOf(claims.get("role", String.class)))
                .build();
    }

...
public class UserController {
    ...
    public ResponseEntity<?> updateUserInfo(@AuthenticationPrincipal TokenUserInfo tokenUserInfo,
                                            @RequestPart("user") Map<String, Object> updateUserInfo,
                                            @RequestPart(value = "profileImage", required = false) MultipartFile profileImage) throws IOException {

        log.info("회원정보 변경 메서드 들어옴");
        log.info("tokenInfo: {} updateUserInfo: {}", tokenUserInfo, updateUserInfo);
        ...
        userService.updateMyInfo(email, updateUserInfo, filePath);

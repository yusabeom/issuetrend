...
public class PaymentService {
    ...
    public PaymentResponseDTO readyPayment(@RequestBody PaymentRequestDTO requestDTO) {
        ...
        params.put("approval_url", "http://localhost:8181/payment/approve/"+requestDTO.getUserNo());
        params.put("cancel_url", "http://localhost:8181/payment/cancel");
        params.put("fail_url", "http://localhost:8181/payment/fail");
